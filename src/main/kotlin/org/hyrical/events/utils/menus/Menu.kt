...
import org.hyrical.events.utils.menus.Button.Companion.createPlaceholder
import org.hyrical.events.utils.menus.fill.FillTemplate
...
abstract class Menu(val testSize: Int = -1) {
    ...
    fun startUpdateTask(player: Player, pagedMenu: Boolean) {
        ...
        }.runTaskTimerAsynchronously(EventsServer.instance, 20L, 20L)
    }
